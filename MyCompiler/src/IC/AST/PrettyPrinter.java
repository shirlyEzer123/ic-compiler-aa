...
public class PrettyPrinter implements Visitor {
	...
	public Object visit(Assignment assignment) {
		...
		output.append(assignment.getExp().accept(this));
		depth -= 2;
		return output.toString();
	}
	...
	public Object visit(Library library) {
		...
		indent(output);
		output.append("Abstract Syntax Tree: " + ICFilePath + "\n");
		indent(output, library);
		output.append("Library signature class: ");
		++depth;
		for (LibraryMethod libMet : library.getMethodList())
			output.append(libMet.accept(this));
		--depth;
		return output.toString();
	}
	...
	public Object visit(ICVoid icVoid) {
		...
		indent(output, icVoid);
		output.append("Primitive data type: ");
		output.append(icVoid.getName());
		return output.toString();
	}
